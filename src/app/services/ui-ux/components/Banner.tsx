...
const Banner = () => {
  return (
    <div className='banner common-padding flex flex-col items-center justify-between gap-20 bg-lightShad2 py-20 lg:flex-row'>
      <ServiceCommonBanner
        title='Transform digital experiences with user centered design'
        description='Crafting intuitive and visually stunning interfaces that engage users and drive results. Experience the power of exceptional UX/UI design tailored to your needs.'
        chip='UX/UI Design service'
        ...
        >
          ...
          <defs>
            ...
            <image
              ...
              width='1080'
              height='2048'
              xlinkHref='https://images.unsplash.com/photo-1507206130118-b5907f817163?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
            />
          </defs>
        </svg>
      </span>
