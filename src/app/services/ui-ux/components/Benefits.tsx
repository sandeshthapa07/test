  ...
  return (
    <div className='bg-lightShad2 '>
      <div className='inter-national main-common-padding flex max-w-[1354px] flex-col items-center gap-[3.25rem]  '>
        <CommonTitle title={'Benefits of AITC for UX/UI design services'} className='text-center' />
        <Image
          ...
          {[1, 2, 3, 4, 5, 6].map((item) => (
            <div className='flex max-w-[310px] flex-col items-center gap-2' key={item}>
              ...
              <div className='flex flex-col gap-4'>
                <CommonHeader title={'Increased user engagement & satisfaction'} className='text-center' />
                <CommonParargraph
                  text={`Users will find your software enjoyable and easy to use, leading to higher adoption rates and loyalty.`}
